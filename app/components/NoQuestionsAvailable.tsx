...
export default function NoQuestionsNotification({ triggerKey, onClose }: Props) {
  ...
  return (
    <div
      className="fixed top-4 right-4 w-80 bg-white text-black rounded-lg shadow-lg z-50 animate-slide-in"
    ...
    >
      ...
      />
      <div className="px-4 py-3 font-medium">No questions available</div>
